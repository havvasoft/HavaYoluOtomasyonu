...
namespace HavaYoluOtomasyonu.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public AirportsController(HavayoluOtomasyonDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AirportId,AirportName,City,Country,Iatacode,TimeZone")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AirportId,AirportName,City,Country,Iatacode,TimeZone")] Airport airport)
        {
